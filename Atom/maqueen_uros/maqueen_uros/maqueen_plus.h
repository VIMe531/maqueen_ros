...
public:
  ...
  void moveRobot(float dx, float daz) {
    motor_speed[0] = (dx / (2 * gear_radius)) - ((daz * gear_width_span) / (2 * gear_radius));
    motor_speed[1] = (dx / (2 * gear_radius)) + ((daz * gear_width_span) / (2 * gear_radius));
